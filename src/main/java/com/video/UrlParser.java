...
public class UrlParser {
	...
	private static final String URL = "https://www.youtube.com/watch?v=oWaXMaBzFzU";
	
	public static void main(String[] args) {
		System.out.println(System.getenv("FFMPEG"));
		CloseableHttpClient httpclient = HttpClients.custom().setProxy(new HttpHost("127.0.0.1", 57073)).build();
		...
		System.out.println(dashStreamList);

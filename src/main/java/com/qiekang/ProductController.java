...
public class ProductController {
	...
	public static void main(String args[]){
		new ProductController().doSearch();
	}
	...
	public void doSearch(){
		SearchResponse response = ESAction.getInstance().client.prepareSearch("producttest")
	        .setTypes("producttype")
	        .setQuery(QueryBuilders.fuzzyQuery("productName", "华山"))                
